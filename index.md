...
By now, you might feel uneasy, but perhaps you’re wondering: what is the real harm of this data collection? When these datasets are sold to advertisers and/or malicious actors, with few safeguards in place, our personal data can be used against us: to manipulate, defraud, or target politically. With the rising popularity of algorithms trained on data, discriminatory profiling is a real threat, especially when individuals are labeled based on protected characteristics, such as race, gender, or income. These decisions may influence equal opportunity to education, healthcare, and financial services, as they can lead to unfair and opaque denial of benefits, inflation of insurance rates, or lowered credit scores.
...
<p align="center">
  <small><i><b>Table 1:</b> This table displays the names and practices of a few major data broker agencies.</i></small>
</p>

## What we did
To shed light on the industry, we analyzed the three key players in the data broker ecosystem: data brokers, consumers, and legislatures. We created a standardized set of questions to compare the three entities across four major categories: data type collected, data use, data sharing, and user controls. We used a data broker dataset compiled by Privacy Rights Clearinghouse, a nonprofit organization focusing on privacy, who compiled data broker information from state registries.[^5] We extracted information about data type from this dataset. After cleaning the dataset of data brokers, we obtained a random sample of 200 data brokers from the full set of approximately 600. From there, we downloaded data broker privacy policies of those 200 data brokers and used Gemini 2.5 and 3 Pro models (“Reasoning, math & code”) to query each privacy policy about data use, data sharing, and user controls. We manually validated a sample of the data. We simultaneously conducted an online survey of university students, using the standardized set of questions. The survey included dropdown questions where participants could easily select which entries they approved of. For example, for a question about data use, participants selected whether they approved of each of the specific use cases of personal data that we listed (biometric, employment, address, geolocation, etc.). We also asked Californian residents two additional questions about the DELETE Act, the strongest state statute on data brokers.[^6] Lastly, we examined state laws covering both data brokers and consumer privacy. Table 2 summarizes our data sources for each form of analysis.
...
<p align="center">
  <small><i><b>Figure 1:</b> This figure displays the frequencies at which data brokers explicitly permit, do not permit, and do not report the collection of several sensitive data types, based on their privacy policies. Many do not explicitly report this information. </i></small>
</p>

<p align="center">
  <img src="notebooks/imgs/Data Collection Practices by Category.svg" alt="Data Collection Practices by Category">
</p>
<p align="center">
  <small><i><b>Figure 2:</b> This figure displays the frequencies at which data brokers explicitly permit and do not permit the collection of several sensitive data types, based on their privacy policies. The "Not Reported" category is not shown, because it encompasses such a significant portion of the results and may be distracting to the explicitly reported information.</i></small>
</p>
...
<p align="center">
  <small><i><b>Figure 3:</b> This figure displays the frequencies at which data brokers permit several use cases of collected personal data.</i></small>
</p>
...
<p align="center">
  <small><i><b>Figure 4:</b> This figure displays the frequencies at which data brokers permit the sharing of personal data to several entities, based on their privacy policies.</i></small>
</p>
...
<p align="center">
  <small><i><b>Figure 5:</b> This figure displays the frequencies at which data brokers provide certain user rights and controls, based on their privacy policies.</i></small>
</p>
...
<p align="center">
  <small><i><b>Figure 6:</b> This figure displays the frequencies at which survey respondents were familiar with data brokers prior to the administration of the survey. It may be slightly skewed toward familiarity because some respondents were students in a data ethics class.</i></small>
</p>
...
<p align="center">
  <small><i><b>Figure 7:</b> This figure displays the frequencies at which survey respondents believed data brokers collected several sensitive types of data.</i></small>
</p>
...
<p align="center">
  <small><i><b>Figure 8:</b> This figure displays the frequencies at which survey respondents were comfortable with data brokers collecting several sensitive types of data.</i></small>
</p>

In terms of the purposes personal data collected by data brokers is used for, the most “approved” category was personalized advertising (62.9%), and then marketing (43.6%) and employment (25.8%). Results indicated general disapproval around their personal data being used across purposes—24.2% responded that they were uncomfortable with all the options. These results are shown in Figure 9.
...
<p align="center">
  <small><i><b>Figure 11:</b> This figure displays the frequencies at which survey respondents desired several user rights and controls in data broker privacy policies and laws.</i></small>
</p>
...
Several federal frameworks may also constrain the practices of data brokers, but only in specific domains. For example, the Fair Credit Reporting Act (FCRA) regulates consumer reporting agencies, the Health Insurance Portability and Accountability Act (HIPAA) covers patient privacy, and the Children’s Online Privacy Protection Act (COPPA) protects the privacy of those under 13. The Federal Trade Commission (FTC), an independent agency, has authority to restrain unfair and deceptive trade and has brought actions against data brokers. That said, the FTC sometimes lacks authority over enforcing against actions that do not fall within its statutory mandate, and enforcement is reactive, not practice. Congress has enacted regulation prohibiting the sale or sharing of personal information with foreign adversary countries or entities they control, but this law does not restrict transfers to domestic entities. Furthermore, there does not exist a comprehensive federal framework governing consumer privacy, much less data brokers.

Nineteen states lack comprehensive consumer privacy laws, but only four (California, Oregon, Texas, and Vermont) explicitly regulate data brokers through standalone data broker registration laws. These states not only address data brokers directly in their privacy frameworks but also require them to register with the state on an annual basis. Some merely require registration, while others provide consumers with some rights and controls over their personal data. They generally mandate opt‑out provisions for third‑party data sharing and sales, grant consumers rights to access, correct, and delete personal data, and prohibit discriminatory uses of such data.
...
<p align="center">
  <small><i><b>Figure 13:</b> This figure displays disparities in the frequencies at which survey respondents were comfortable with their data being used for several purposes (blue) and the frequencies at which those uses were actually permitted, based on uses explicitly mentioned in data broker privacy policies (red).</i></small>
</p>
...
Furthermore, results from Californians asked about the DELETE Act reinforce that merely passing a statute is not enough to provide consumers with data protections. Education plays a crucial role in helping individuals understand and exercise their data rights. Despite only a quarter of surveyed Californians knew about the DELETE Act prior to taking the survey, over 90% expressed willingness to use the tools that the California Privacy Protection Agency will provide during DELETE Act implementation.

However, while education is important, an approach that solely relies on individuals to delete their own data is wholly insufficient for providing meaningful privacy. This deficiency is especially acute given the enormity of the data broker industry, whose business model depends on its secrecy. While data broker companies must comply with privacy statutes in jurisdictions in which they operate, they often turn a blind eye to consumers’ privacy beyond publishing lengthy, difficult-to-read privacy policies.[^7] These policies are extremely difficult to parse (even for those with a university-level education) and would take approximately 30 minutes to read each. 
...
[^4]: Sherman, 2021
[^5]: Privacy Rights Clearinghouse, n.d.
[^6]: California Privacy Protection Agency (CPPA), 2025
[^7]: Litman-Navarro, 2019
[^8]: Trujillo & Tsukayama, 2025; Solove, 2023

## References
- Auxier, B., Rainie, L., Anderson, M., Perrin, A., Kumar, M., & Turner, E. (2019, November 15). Americans’ Attitudes and Experiences with Privacy Policies and Laws. Pew Research Center: Internet, Science & Tech. https://www.pewresearch.org/internet/2019/11/15/americans-attitudes-and-experiences-with-privacy-policies-and-laws/
...
- *California Consumer Privacy Act (CCPA)*. (2024, March 13). State of California Office of the Attorney General. https://oag.ca.gov/privacy/ccpa
- *California Privacy Protection Agency (CPPA)*. (n.d.). Information for Data Brokers. State of California. https://cppa.ca.gov/data_brokers/
- *California Privacy Protection Agency (CPPA)*. (2025, November 13). California Approves Delete Act Regulations. https://cppa.ca.gov/announcements/2025/20251113.html
- Curtis, D. (2021, July 1). Nevada Expands Online Privacy Law; Goes for Brokers. Orrick. https://www.orrick.com/en/insights/2021/07/Nevada-Expands-Online-Privacy-Law-Goes-for-Brokers#new-requirements
- *Data Broker Watch.* (n.d.). https://databrokerswatch.org/
- Division of Financial Regulation. (n.d.). *Consumer Privacy Resources*. State of Oregon. https://dfr.oregon.gov/financial/protect/Pages/consumer-privacy-resources.aspx
- Electronic Privacy Information Center. (n.d.). *Data Brokers.* Electronic Privacy Information Center (EPIC). https://epic.org/issues/consumer-privacy/data-brokers/
- Fitzgerald, C., & Williams, K. (2025). *The State of Privacy.* Electronic Privacy Information Center (EPIC).
- *FTC Takes Action Against Gravy Analytics, Venntel for Unlawfully Selling Location Data Tracking Consumers to Sensitive Sites.* (2024, December 1). Federal Trade Commission. https://www.ftc.gov/news-events/news/press-releases/2024/12/ftc-takes-action-against-gravy-analytics-venntel-unlawfully-selling-location-data-tracking-consumers
- *FTC Takes Action Against Mobilewalla for Collecting and Selling Sensitive Location Data.* (2024, December 3). Federal Trade Commission. https://www.ftc.gov/news-events/news/press-releases/2024/12/ftc-takes-action-against-mobilewalla-collecting-selling-sensitive-location-data
- Greisz, E. (2025). Transparency Without Teeth: An Empirical Understanding of Data Broker Regulation. *The University of Chicago Law Review*, 92(4), 1027–1123. https://chicagounbound.uchicago.edu/cgi/viewcontent.cgi?article=6434&context=uclrev
- *Know Your Rights Under the Texas Data Privacy and Security Act.* (2025, January 28). Texas Department of Information Resources. https://dir.texas.gov/news/know-your-rights-under-texas-data-privacy-and-security-act
- Lam, C. (n.d.). *Understanding the Work of Data Brokers and Their Impact on Data Privacy.* TrustArc. https://trustarc.com/resource/data-brokers-impact-data-privacy/
...
- Lomas, N. (2018, June 6). *Cambridge Analytica’s Nix said it licensed “millions of data points” from Acxiom, Experian, Infogroup to target US voters*. TechCrunch. https://techcrunch.com/2018/06/06/cambridge-analyticas-nix-said-it-licensed-millions-of-data-points-from-axciom-experian-infogroup-to-target-us-voters/
